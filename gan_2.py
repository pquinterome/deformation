...
#########Inputs and Outputs##########
ct0 = np.load('./cbct_project/validation/ct_0.npy')
cbct0 = np.load('./cbct_project/validation/cbct_0.npy')
ct1 = np.load('./cbct_project/validation/ct_1.npy')
cbct1 = np.load('./cbct_project/validation/cbct_1.npy')
ct2 = np.load('./cbct_project/validation/ct_2.npy')
cbct2 = np.load('./cbct_project/validation/cbct_2.npy')
ct3 = np.load('./cbct_project/validation/ct_3.npy')
cbct3 = np.load('./cbct_project/validation/cbct_3.npy')
ct4 = np.load('./cbct_project/validation/ct_4.npy')
cbct4 = np.load('./cbct_project/validation/cbct_4.npy')
ct5 = np.load('./cbct_project/validation/ct_5.npy')
cbct5 = np.load('./cbct_project/validation/cbct_5.npy')
ct6= np.load('./cbct_project/validation/ct_6.npy')
cbct6 = np.load('./cbct_project/validation/cbct_6.npy')
