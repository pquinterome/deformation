...
pca = pca_val[:400]
pca = np.concatenate((pca, pca, pca), axis=0)
#pca = pca[:,0]
...
print(X_train.shape)
print(X_test.shape)
X_train = X_train.reshape(960, 58, 156, 156,1)
X_test = X_test.reshape(240, 58, 156, 156,1)
batch_size=10
...
x = Conv3D(filters=120, kernel_size=(6,6,6), activation='relu', padding='same')(x)
