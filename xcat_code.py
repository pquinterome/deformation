...
mri_2 = mri_2[-50:]
mri = np.concatenate((mri_1, mri_2)).astype('float32',casting='same_kind')
...
print(X_train.shape)
print(X_test.shape)
X_train = X_train.reshape(80, 80, 256, 256, 1)
X_test = X_test.reshape(20, 80, 256, 256, 1)
print(X_train.shape)
print(X_test.shape)
#
#
...
#with strategy.scope():
    # Model for MRI
i = Input(shape=(80, 256, 256, 1))
x = Conv3D(filters=32, kernel_size=(8,8,8), activation='relu', padding='same')(i)
x = MaxPool3D(pool_size=(8,8,8))(x)
x = Conv3D(filters=16, kernel_size=(6,6,6), activation='relu', padding='same')(x)
