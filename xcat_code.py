...
early_stop = EarlyStopping(monitor='val_loss', patience=3)
#
history = model1.fit(x=X_train, y= y_train, validation_data= (X_test, y_test), epochs=100, callbacks=[early_stop], verbose=1, batch_size=16)
